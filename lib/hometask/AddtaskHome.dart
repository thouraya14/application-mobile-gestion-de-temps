...
class AddTaskHomePage extends StatefulWidget {
  const AddTaskHomePage({Key? key}) : super(key: key);

  @override
  _AddTaskHomePageState createState() => _AddTaskHomePageState();
}

class _AddTaskHomePageState extends State<AddTaskHomePage> {
  ...
  _saveTaskToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('taskHome').add({
