...
class AddLeisuresTaskPage extends StatefulWidget {
  const AddLeisuresTaskPage({Key? key}) : super(key: key);

  @override
  _AddTaskLeisuresPageState createState() => _AddTaskLeisuresPageState();
}

class _AddTaskLeisuresPageState extends State<AddLeisuresTaskPage> {
  ...
  _saveTaskToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('taskLeisures').add({
