...
class AddTaskWorkPage extends StatefulWidget {
  const AddTaskWorkPage({Key? key}) : super(key: key);

  @override
  _AddTaskPageState createState() => _AddTaskPageState();
}

class _AddTaskPageState extends State<AddTaskWorkPage> {
  ...
  void initState() {
    super.initState();
    _fetchUsers(); // Appeler la méthode pour récupérer les utilisateurs au début
  }
  ...
  _saveTaskToFirestore() async {
    try {
      await FirebaseFirestore.instance.collection('taskWork').add({
